...
plane sector. That is $22{,}925$ packets for $d = 2, \dots, 7$, including all of $\Tp_{A_7}$ for
$\ell \le 5$ and $\Tp_{A_6}$ for $\ell \le 8$ (\texttt{results/ballot\_conjecture.json}). Off the
